...
(* type t_l_color = Red | Yellow | Green *)
print_endline
  "Interpreted as current traffic light color in tl-simulator program?"
;;
...
(* - : unit = () *)
let next_color = function Red -> Green | Yellow -> Red | Green -> Yellow;;
...
(* - : unit = () *)
print_endline
  "takes a cityname and returns true if it is the best city in the world"
...
(* Error: This expression has type bool but an expression was expected of type
         cityname -> bool *)
let best_city cn = String.equal my_city cn;;
